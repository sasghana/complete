import { Component, Input, ChangeDetectionStrategy, AfterViewInit, AfterViewChecked, ChangeDetectorRef, OnInit } from '@angular/core';
...
export class DashboardComponent implements OnInit, AfterViewChecked {
  ...
  colorSchemeSmallChart = { domain: COLORSINVERT };
  schemeType = 'ordinal';
  ...
  constructor(public snackBar: MatSnackBar, private cdRef: ChangeDetectorRef) {
    Object.assign(this, {
      single,
      multi
    });
    ...
    this.snackBar.open(
      'Welcome to SAS Intranet, We serve you better',
      '',
      config
    );
  }
