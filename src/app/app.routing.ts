...
export const AppRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'issuetracker', loadChildren: './issuetracker/issuetracker.module#IssuetrackerModule'},
      { path: 'leaveform', loadChildren: './leaveform/leaveform.module#LeaveformModule'},
      { path: 'claimsform', loadChildren: './claimsform/claimsform.module#ClaimsformModule'}
    ]
  },
  {
